      ...
      <div className="navbar container mx-auto px-2 md:px-4">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="dropdown-content mt-2 z-[1] p-2 shadow bg-background border-primary border text-text w-52"
            >
              {links}
            </ul>
          </div>
        ...
        <div className="navbar-end">
          <button className="btn bg-transparent hover:bg-white text-white hover:text-primary border-white hover:border-white">
            SIGN IN
          </button>
        </div>
      </div>
